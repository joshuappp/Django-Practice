...
SECRET_KEY = '_oxvazqhu#sxb%4qwo-bi8p^w6(#tl4&x$e5updwy73^g+&f9('
...
#Custom to check if user logined or not   or you can use this on your method: @login_required(login_url='/login')
LOGIN_URL='/login'
